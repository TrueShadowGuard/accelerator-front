...
import classes from './ThirdCommentModule.module.css'
...
const ThirdCommentModule = (props) => {
  ...
  ThirdCommentModule.propTypes = {
    postComment: PropTypes.func
  };

  return (
      <div className={classes.thirdCommentModule}>
        <Box
            component="form"
            sx={{ maxWidth:"450px",
...
export default ThirdCommentModule;
